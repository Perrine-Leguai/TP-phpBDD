                                ...
                                <form action="<?php  if( $action == "modifier"){ echo "../controler/employeControler.php?action=modifier"; }else{ echo "../controler/employeControler.php?action=ajout" ; } ?>&amp;noemp=<?php if( $action== "modifier"){echo $_GET['noemp']; }?>" method="POST">
                                        ...
                                        <div class="row justify-content-md-center">
                                            ...
                                            <div class="col-12 row justify-content-md-center">
                                                ...
                                                <div><input type="number" name="noemp" id="noemp" placeholder="ex : 1023" value="<?php if ($action =='modifier'){ echo $employe->getNoemp();}?>" requirred></div>
                                            </div>
                                            <!-- NOM & PRENOM -->
                                                ...
                                                <div class="  row justify-content-md-center m-2 ">
                                                    <div class=" row mr-2">
                                                        ...
                                                        <div><input type="text" name="nom" id="nom" placeholder="ex: Dupont " value="<?php if( $action =='modifier'){ echo $employe->getNom(); }?>" ></div>
                                                    </div>
                                                    <div class=" row justify-content-md-center ml-2">
                                                        <div class="p-1"><label for="prenom"> Prénom : </label></div>
                                                        <div><input type="text" name="prenom" id="prenom" placeholder="ex: Valérie " value="<?php if ($action =='modifier'){ echo $employe->getPrenom(); }?>"></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class=" row justify-content-md-center m-2 ">
                                                <div class=" row mr-2">
                                                    ...
                                                    <div><input type="text" name="emploi" id="emploi" placeholder="ex: Infirmière " value="<?php if ($action =='modifier'){ echo $employe->getEmploi(); }?>"></div>
                                                </div>
                                                <div class=" row ml-2">
                                                    <div class="p-1"><label for="embauche"> Embauche :</label></div>
                                                    <div><input type="text" name="embauche" id="embauche" placeholder="ex: 1988-12-15 " value="<?php if ($action=='modifier'){ echo $employe->getEmbauche(); }?>"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" row justify-content-md-center m-2 ">
                                                <div class=" row mr-2">
                                                    ...
                                                    <div><input type="number" name="sal" id="sal" placeholder="ex: 12345.6 " value="<?php if ($action =='modifier'){ echo $employe->getSal(); }?>"></div>
                                                </div>
                                                <div class=" row ml-2">    
                                                    <div class="p-1"><label for="comm"> Commission :</label></div>
                                                    <div><input type="number" name="comm" id="comm" placeholder="ex: 78910.26 " value="<?php if ($action =='modifier'){ echo $employe->getComm(); }?>"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" row justify-content-md-center col-12 m-2 ">        
                                                ...
                                                <div ><input type="number" name="sup" id="sup" placeholder="ex: 1054" value="<?php if ($action =='modifier'){ echo $employe->getSup(); }?>"></div>
                                            </div>

                                            <!-- N° SERVICE -->
                                            <div class=" row justify-content-md-center col-12 m-2 ">        
                                                <div clas="p-1"><label for="noserv"> N° service : </label></div>
                                                <div><input type="number" name="noserv" id ="noserv" placeholder="ex: 4 " value="<?php if ($action =='modifier'){ echo $employe->getNoserv(); }?>"></div>
                                            </div>
